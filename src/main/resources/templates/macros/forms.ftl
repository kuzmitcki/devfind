            ...
            <form style="background-color: white; padding: 30px;" class="col-5"  method="post" action="${path}">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <input style=" border-radius: 8px;" type="text" class="form-control" name="degree" id="inputDegree" >
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input  style="border-radius: 8px;" type="text" class="form-control" name="place" id="inputEducation">
                </div>
                <div class="form-group">
                    ...
                    <input style="color: #4b4b4b; border-radius: 8px" class="form-control" id="fieldOfStudy" type="text" name="fieldOfStudy">
                </div>
                <div class="form-group">
                    ...
                    <input style="color: #4b4b4b; border-radius: 8px" class="form-control" id="city" type="text" name="city">
                </div>
                <div class="form-row">
           ...
           <form style="background-color: white;padding: 30px;" class="col-5" method="post" action="${path}">
               ...
               <div class="form-group">
                   <div class="form-group">
                       ...
                       <input style=" border-radius: 8px;" type="text" class="form-control" name="firstName" id="inputFirstName"  placeholder="Enter first name">
                   </div>
               </div>
               <div class="form-group">
                   ...
                   <input  style="border-radius: 8px;" type="text" class="form-control" name="lastName" id="inputLastName" placeholder="Enter last name">
               </div>
               <div class="form-group">
